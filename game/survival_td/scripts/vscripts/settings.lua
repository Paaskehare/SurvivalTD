...
FORCE_PICKED_HERO = "npc_dota_hero_omniknight" -- What hero should we force all players to spawn as? (e.g. "npc_dota_hero_axe").  Use nil to allow players to pick their own hero.
...
TEAM_COLORS[DOTA_TEAM_CUSTOM_7] = { 140, 42, 244 }  --    Purple
